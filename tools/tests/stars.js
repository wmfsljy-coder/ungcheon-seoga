...
function days(hb,list){list.forEach(d=>{
  ...
  const k=["label","review","quizmk","quizsv"][i]||(i%2?"review":"label");
  if(k==="quizsv")T["퀴즈응답"].push({"주":w,"학번":hb,"점수":"4","문항수":"5","시각":d+" 1"+(pid++%10)+":00:00"});
  else if(k==="quizmk")T["퀴즈"].push({"id":"q"+(pid++),"시각":d+" 1"+(pid%10)+":00:00","학번":hb,"책제목":"책"+pid,"문제":"문제","품질":"8","상태":"대기","출처":"학생"});
...
days("3101",["2026-08-26",...wk("2026-09-01",4),...wk("2026-09-07",4),...wk("2026-09-14",4),...wk("2026-09-21",4),
  "2026-09-28","2026-09-28","2026-09-29","2026-09-30"]);                            /* 8월 1 + 9월 20 = 도장 21 · 별 4 */
days("3102",[...wk("2026-09-07",4),...wk("2026-09-14",4),...wk("2026-09-21",4),"2026-09-28","2026-09-28","2026-09-29"]); /* 9월 15 = 별 3 */
days("3103",[...wk("2026-09-14",4),"2026-09-21","2026-09-22","2026-09-23"]);        /* 9월 7 = 별 1 + 남은 도장 2 */
days("3104",[...wk("2026-07-06",4),...wk("2026-07-13",4),...wk("2026-07-20",4),...wk("2026-07-27",4),
  ...wk("2026-08-03",4),...wk("2026-08-10",4),...wk("2026-08-17",4),...wk("2026-08-24",4)]);   /* 여름 내내 32 = 별 6 */
days("3105",["2026-09-28","2026-09-28","2026-09-29","2026-09-29","2026-09-30","2026-09-30"]);  /* 한 주 6편 → 도장 4 + 책갈피 2 */
...
posts("3101","2026-10-05",4);NOW=new Date("2026-10-07T03:00:00Z");
