...
q({"상태":"출제","주":"2026-10-19"});              // 아직 오지 않은 주 — 지워야 함
...
must(dropped===3,"미리 만든 문제 3건을 지웠다 (실제 "+dropped+")");
must(T["퀴즈"].length===before-3,"시트에서 실제로 빠졌다");
...
must(!has(r=>r["상태"]==="출제"&&r["주"]>wk),"아직 오지 않은 주의 문제는 사라졌다");
